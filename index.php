...
if (isset($_SESSION['ultimo_acesso'])) {
    ...
    if ($tempoInativo > $tempoMaximo) {
        ...
        session_unset();
        session_destroy();
        header("Location: Public/login/index.php?message=Sua sessão expirou. Por favor, faça login novamente.");
        exit;
    }
}
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-item">
                <a href="Public/produtos/index.php" class="sidebar-nav-link">
            ...
            <!-- Etiquetas -->
            <li class="sidebar-nav-item">
                <a href="Public/etiqueta/index.php" class="sidebar-nav-link active">
            ...
            <!-- Importar -->
            <li class="sidebar-nav-item">
                <a href="Public/importar/index.php" class="sidebar-nav-link">
            ...
            <!-- Funcionarios -->
            <li class="sidebar-nav-item">
                <a href="Public/funcionarios/index.php" class="sidebar-nav-link">
            ...
            <!-- Troca -->
            <li class="sidebar-nav-item">
                <a href="Public/troca/index.php" class="sidebar-nav-link">
            ...
            <!-- vendas -->
            <li class="sidebar-nav-item">
                <a href="Public/vendas/index.php" class="sidebar-nav-link">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-nav">
            ...
            <!-- Financeiro -->
            <li class="sidebar-nav-item">
                <a href="Public/financeiro/index.php" class="sidebar-nav-link">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-nav">
            <!-- Despesas gerais -->
            <li class="sidebar-nav-item">
                <a href="Public/despesas/index.php?view=despesas&page=1" class="sidebar-nav-link">
...
// Cálculo das Deduções (Custo Diário)
$sqlCustoHoje = "
  SELECT COALESCE(SUM(
    iv.quantidade
    * COALESCE(pdirect.preco_custo, pvar.preco_custo)
...
// Top 5 Semana (ajustado para casar com o template do dia)
 $sqlTop = "
...
// Recebe o mês via GET (YYYY-MM) ou usa o mês corrente
$mesSelecionado = $_GET['month'] ?? date('Y-m');
if (!preg_match('/^\d{4}-\d{2}$/', $mesSelecionado)) {
    $mesSelecionado = date('Y-m');
}

// Define intervalo completo do mês selecionado
$dataInicioMes = "{$mesSelecionado}-01 00:00:00";
$dataFimMes    = date('Y-m-t', strtotime($dataInicioMes)) . ' 23:59:59';

// Cálculo das Deduções (Custo Mensal), baseado no código de Custo Diário
$sqlCustoMes = "
  SELECT COALESCE(SUM(
    iv.quantidade
    * COALESCE(pdirect.preco_custo, pvar.preco_custo)
...
// Cálculo do Líquido Mensal
$liquidoMesAtual = $brutoMesAtual - $deducoesMesAtual;

// Se não houve faturamento, zera tudo
if ($brutoMesAtual == 0) {
